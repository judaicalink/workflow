...
ep_new_index = {k:v for k,v in ep_new_index.items() if len(v) >= 1}
...
ep_g = epm.generate_ep_graph(ep_new_index, save=True, return_graph=True, outpath=cwd+"/runs/run_"+str(current)+'/entity_pages.ttl', rdf_format='ttl')
